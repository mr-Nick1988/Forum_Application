...
public class ForumController {
    ...
    public List<PostResponseDto> findPostsByPeriod(@RequestParam LocalDateTime from, @RequestParam LocalDateTime to) {
    ...
    public List<PostResponseDto> findPostsByTags(@RequestParam List<String> tags){
